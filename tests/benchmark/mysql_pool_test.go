...
// Using defer sqlDB.Close() right after opening the connection is a safer and more convenient approach to ensure resources are released,
// avoiding connection leaks, and aligning with Go's best practices.
// Benchmark in Go is the process of measuring code performance to determine execution speed,
// resource usage, or optimize code, using the testing package with functions prefixed by Benchmark.
